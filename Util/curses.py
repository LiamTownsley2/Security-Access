...
def interface_status(stdscr, starting_row:int, rfid_status:bool, api_status:bool):
        # Interface Status
        stdscr.addstr(starting_row,0,"Interface Status:" + Util.general.repeat(" ", 32), curses.color_pair(1) | curses.A_BOLD)

        #   RFID Scanning
        stdscr.addstr(9, 0, "RFID Scanning Interface:" + Util.general.repeat(" ", 25), curses.color_pair(1) | curses.A_BOLD)
        is_operational_curses(stdscr, 9, 25, rfid_status)
        
        #   Web Interface
        stdscr.addstr(10, 0, "Web Interface:" + Util.general.repeat(" ", 35), curses.color_pair(1) | curses.A_BOLD)
